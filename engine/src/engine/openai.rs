...
pub async fn chat_json(system: &str, user: &str) -> Result<Value> {
    ...
    let res = client
      .post(std::env::var("OPENAI_API_URL").unwrap_or("https://api.openai.com/v1/chat/completions".into()))
    ...
    if status != StatusCode::OK {
        ...
        return Ok(json!({"reply":"⟂ openai http_error","error":text,"bits":{"A":0,"U":1,"P":0,"E":1,"Δ":0,"I":0,"R":0,"T":0,"M":0}}));
    }
    ...
    match serde_json::from_str::<Value>(content) {
        ...
        Err(_) => {
            ...
            Ok(json!({"reply":content,"bits":{"A":1,"U":0,"P":0,"E":0,"Δ":0,"I":0,"R":0,"T":1,"M":0}}))
        }
    }
}
